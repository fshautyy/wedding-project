        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/beranda/1.jpg')}}" alt="Image" class="img-fluid">
                </div>
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/beranda/2.jpeg')}}" alt="Image" class="img-fluid">
                </div>
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/beranda/3.jpg')}}" alt="Image" class="img-fluid">
                </div>
              </div>
          ...
          <div class="col-lg-4 order-lg-1">
            ...
            <h1 class="mb-4" data-aos="fade-up">
              Buat Undangan Pernikahan Digital yang Elegan & Tak Terlupakan
            </h1>
            <p data-aos="fade-up">
              Rayakan momen istimewa Anda dengan undangan pernikahan digital yang modern, praktis, dan penuh sentuhan personal.
              Kami menghadirkan desain premium, fitur interaktif, serta tampilan yang bisa disesuaikan sesuai gaya dan cerita cinta Anda.

              Mulai dari tema klasik, minimalist, rustic, hingga modern elegant—semua dapat Anda pilih dan kustomisasi dengan mudah.
              Kini, membagikan undangan ke keluarga dan sahabat cukup dengan satu klik.
            </p>
          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                <div class="img">
                  <img src="{{asset('landingPages/img/img_v_3.jpg')}}" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5">
            <div class="images-overlap">
              <img src="{{asset('landingPages/img/img_v_1.jpg')}}" alt="student" class="img-fluid img-1" data-aos="fade-up">
            </div>
          </div>
        ...
        <div class="row gy-4">
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
              <a href="#" class="thumb d-block"><img src="{{asset('landingPages/img/img_h_4.jpg')}}" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-content">
                ...
                <div class="d-flex author align-items-center">
                  <div class="pic">
                    <img src="{{asset('landingPages/img/team/team-3.jpg')}}" alt="Image" class="img-fluid rounded-circle">
                  </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
              <a href="#" class="thumb d-block"><img src="{{asset('landingPages/img/img_h_2.jpg')}}" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-content">
                ...
                <div class="d-flex author align-items-center">
                  <div class="pic">
                    <img src="{{asset('landingPages/img/team/team-2.jpg')}}" alt="Image" class="img-fluid rounded-circle">
                  </div>
                  <div class="author-name">
                    <strong class="d-block">Winston Gold</strong>
                    <span class="">Lead Product Designer</span>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
              <a href="#" class="thumb d-block"><img src="{{asset('landingPages/img/img_h_3.jpg')}}" alt="Image" class="img-fluid rounded"></a>
              ...
              <div class="post-content">
                ...
                <div class="d-flex author align-items-center">
                  <div class="pic">
                    <img src="{{asset('landingPages/img/team/team-1.jpg')}}" alt="Image" class="img-fluid rounded-circle">
                  </div>
                  <div class="author-name">
                    <strong class="d-block">Winston Gold</strong>
                    <span class="">Lead Product Designer</span>
        ...
        <div class="row gap-x-lg-4 justify-content-between">
          ...
          <div class="col-lg-8">
            <div class="swiper init-swiper-tabs">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/img_h_1.jpg')}}" alt="Image" class="img-fluid">
                  <div class="p-4">
                ...
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/img_h_2.jpg')}}" alt="Image" class="img-fluid">
                </div>
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/img_h_3.jpg')}}" alt="Image" class="img-fluid">
                </div>
                <div class="swiper-slide">
                  <img src="{{asset('landingPages/img/img_h_4.jpg')}}" alt="Image" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{asset('landingPages/img/testimonials/testimonials-1.jpg')}}" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{asset('landingPages/img/testimonials/testimonials-2.jpg')}}" alt="Image" class="img-fluid">
                    </figure>
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{asset('landingPages/img/testimonials/testimonials-3.jpg')}}" alt="Image" class="img-fluid">
                    </figure>
